...
private:
    ...
    enum class ResultType { LIST, HIERARCHY, PATH };
    ...
    CmdResult cmd_vassals(std::ostream& output, MatchIter begin, MatchIter end);
    ...
    CmdResult print_town(TownID id, std::ostream& output);
